...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const canonicalUrl = `https://www.thesmugsaver.com/${category.slug}`;
    ...
    return {
        ...
        openGraph: {
            ...
            type: 'website',
            images: [{ url: 'https://www.thesmugsaver.com/og-image.jpg', width: 1200, height: 630, alt: `${category.title} - The Smug Saver` }],
        },
        twitter: {
