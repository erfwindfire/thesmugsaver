...
export function generateMetadata({ searchParams }: Props): Metadata {
    return {
        title: `Search Results for "${searchParams.q || ''}" - The Smug Saver`,
                ...
                {results.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-xl border border-gray-100">
                        ...
                        <div className="mt-8 flex flex-wrap justify-center gap-3">
                            <Link href="/budgeting" className="px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-bold hover:border-primary hover:text-primary transition-colors">
                                Budgeting
                            </Link>
                            <Link href="/savings-and-investing" className="px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-bold hover:border-primary hover:text-primary transition-colors">
                                Savings
                            </Link>
                            <Link href="/cost-of-living" className="px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-bold hover:border-primary hover:text-primary transition-colors">
                                Cost of Living
                            </Link>
                        </div>
                    </div>
