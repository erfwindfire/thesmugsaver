...
</ul><h2 class="text-2xl font-bold text-gray-900 mt-10 mb-4">1. Energy Bill Negotiations: Scripts That Actually Work</h2>
...
<div class="mt-12 pt-8 border-t border-gray-200">
  ...
  <div class="mb-6">
    ...
    <p class="text-xs text-gray-500">Data based on March 2026 UK energy prices, broadband market rates, insurance benchmarks, and council tax guidelines from Citizens Advice and Ofgem.</p>
  </div>

  <div class="mb-8">
    <h3 class="text-base font-semibold text-gray-800 mb-3">Key Legislation</h3>
    <ul class="space-y-2 text-sm text-gray-600">
      <li><a href="https://www.legislation.gov.uk/ukpga/2003/21/contents" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Communications Act 2003</a> — Establishes Ofcom's authority to regulate broadband and mobile services, protect consumers, and enforce quality standards.</li>
      <li><a href="https://www.ofgem.gov.uk/" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Ofgem Licence Conditions</a> — Sets consumer protections for energy suppliers including cooling-off periods and dispute resolution.</li>
    </ul>
  </div>
  ...
  <div>
    ...
    <ul class="space-y-2 text-sm text-gray-600">
      <li><a href="https://www.ofcom.org.uk/" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Ofcom — Broadband &amp; Mobile</a> — Regulator for UK telecom services; compare deals and file complaints.</li>
      <li><a href="https://www.ofgem.gov.uk/" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Ofgem — Energy Price Cap</a> — Sets energy price caps and consumer protections; provides tariff comparison tools.</li>
      <li><a href="https://www.citizensadvice.org.uk/" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Citizens Advice — Consumer Rights</a> — Free guidance on negotiating bills, complaints, and legal rights.</li>
      <li><a href="https://www.moneyhelper.org.uk/" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">MoneyHelper — Budgeting &amp; Bills</a> — FCA-regulated guidance on managing household bills and budgeting.</li>
      <li><a href="https://www.moneysupermarket.com/" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">MoneySuperMarket — Bill Comparison</a> — Compare energy, broadband, and insurance rates across UK providers.</li>
      <li><a href="https://www.gov.uk/council-tax" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">GOV.UK — Council Tax Appeals</a> — Official guidance on challenging council tax bands and reductions.</li>
    </ul>
  </div>
