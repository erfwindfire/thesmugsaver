...
<div class="mt-12 pt-8 border-t border-gray-200">
  ...
  <div class="mb-6">
    ...
    <p class="text-xs text-gray-500">Based on ONS inflation data, DWP benefit rates, Ofgem price cap figures, and current government support schemes as of March 2026.</p>
  </div>

  <div class="mb-8">
    <h3 class="text-base font-semibold text-gray-800 mb-3">Key Legislation</h3>
    <ul class="space-y-2 text-sm text-gray-600">
      <li><a href="https://www.legislation.gov.uk/ukpga/2012/5/contents" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Welfare Reform Act 2012</a> — Establishes the framework for benefits including Universal Credit and conditions for cost-of-living support.</li>
      <li><a href="https://www.legislation.gov.uk/ukpga/2015/15/contents" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Consumer Rights Act 2015</a> — Protects consumers in energy switching and utility contract negotiations.</li>
    </ul>
  </div>
  ...
  <div>
    ...
    <ul class="space-y-2 text-sm text-gray-600">
      <li><a href="https://www.ons.gov.uk/economy/inflationandpriceindices" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Office for National Statistics — Inflation and Price Indices</a> — Current inflation figures and retail price indices.</li>
      <li><a href="https://www.gov.uk/energy-support" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">GOV.UK — Energy Support</a> — Official government energy bill support schemes and eligibility.</li>
      <li><a href="https://www.ofgem.gov.uk/price-cap" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Ofgem — Price Cap</a> — Current energy price cap rates and comparison tools.</li>
      <li><a href="https://www.gov.uk/benefits" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">GOV.UK — Benefits</a> — Comprehensive benefits guidance and eligibility checker.</li>
      <li><a href="https://www.moneyhelper.org.uk" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">MoneyHelper — Cost of Living Support</a> — Free independent financial guidance on managing costs.</li>
      <li><a href="https://www.citizensadvice.org.uk" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">Citizens Advice</a> — Independent advice on benefits, energy, and consumer rights.</li>
      <li><a href="https://www.stepchange.org" class="text-emerald-700 underline hover:text-emerald-900" target="_blank" rel="noopener noreferrer">StepChange — Debt Charity</a> — Free debt advice and budgeting support for households in crisis.</li>
    </ul>
  </div>
