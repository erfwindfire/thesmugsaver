...
<div class="mt-12 pt-8 border-t border-gray-200">
  ...
  <div class="bg-white border border-[#E8E8E8] rounded-lg p-5 mb-8 shadow-sm">
    ...
    <p class="text-sm text-gray-700 leading-relaxed">This guide provides general information about student finance in the UK. For personalized advice on student loans, grants, and financial support, contact the Student Loans Company (slc.co.uk) directly. MoneyHelper (moneyhelper.org.uk) also offers free, impartial guidance on managing student finances and budgeting during your studies.</p>
  </div>
